...
export function BigScreen() {
  ...
  useEffect(() => {
    ...
    const endTimeMs = serverNowMs + ((currentSession.timeRemainingSeconds ?? currentSession.currentQuestion.timer) * 1000);
  ...
  }, [view, currentSession?.currentQuestion, currentSession?.timeRemainingSeconds, currentSession?.serverNow, currentSession?.status]);
